...
from ui_coverage_tool.src.history.models import ScenarioHistory, AppHistory
from ui_coverage_tool.src.tools.actions import ActionType, ActionCoverage
from ui_coverage_tool.src.tools.selector import SelectorType
from ui_coverage_tool.src.tools.types import Selector, ScenarioName
